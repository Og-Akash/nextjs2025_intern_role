      ...
      <div className="flex h-full justify-between mx-8 items-center">
        <div className="inline-flex gap-3 items-center">
         <ArrowLeft />
          ...
          <ThemeToggleButton />
        <div className={`max-w-60 w-full flex justify-between items-center ${theme === "dark" && "bg-dark border-dark-50 text-[#fcfcfc]"} bg-[#fcfcfd] p-2 border border-[#E8EFF7] text-[#373B5C] rounded-md `}>
